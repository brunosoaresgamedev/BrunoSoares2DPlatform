...
namespace Platformer2D.Character
{
    ...
    {
        public bool IsMovingCM2D;
        [Header("Walljump")]
        [Range(0.0f, 500f)]
        public float WalljumpForcey = 10;
        [Range(-500, 500f)]
        ...
        [Header("Jump")]
        [SerializeField]public float maxJumpHeight = 4.0f;
     ...
     /*
        public void WallJump()
        {
            if (!isGrounded)
            {
                ...
                if (!playerFacing.facingRight)
                    dir = -1;
                currentVelocity.y =  WalljumpForcey;
                currentVelocity.x = -dir * WalljumpForcex;
              
                Invoke("ReleaseWallJump", dashTime);
        ...
        bool CheckCapsuleCollisionsTop()
        {
            ...
            RaycastHit2D[] hitBuffer = new RaycastHit2D[5];
            float raycastDistance = ColliderInfo.Size.x * 0.5f + groundedRaycastDistance * 4f;
